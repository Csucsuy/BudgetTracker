...
function c(){ const fg=m.Create_1(n);const fh=m.Create_1(q);const fi=m.Create_1("Entertainment");const fj=m.Create_1("");const fk=(fl, fm) => ba.Element("li", [bW("class", bZ((fn) => w(fn, fl)?"active":"", fg.View))], [ba.Element("a", [bX.HandlerImpl("click", () =>() => { if(d()==null)null;else { const fn=d().$0;if(fn&&typeof fn.destroy==="function")fn.destroy();e(null);} return fg.Set(fl);}), bX.Create("style", "cursor: pointer;")], [ba.TextNode(fm)])]);return ba.Element("div", [bX.Create("style", "display: flex; height: 100vh;")], [ba.Element("div", [bX.Create("style", "width: 200px; background-color: #f5f8fa; display: flex; flex-direction: column; justify-content: space-between; padding: 20px;")], [ba.Element("div", [], [ba.Element("h2", [bX.Create("style", "margin: 0; font-size: 18px;")], [ba.TextNode("Budget Tracker")]), ba.Element("p", [bX.Create("style", "margin: 5px 0; font-size: 14px; color: #666;")], [ba.TextNode("for better savings!")])]), ba.Element("ul", [bX.Create("style", "list-style: none; padding: 0; flex-grow: 1;")], [fk(n, "Home"), fk(o, "Transactions"), fk(p, "Analytics")]), ba.Element("div", [], [ba.Element("p", [bX.Create("style", "margin: 0; font-size: 12px; color: #888;")], [ba.TextNode("Owner: Patrik Grasics")])])]), ba.Element("div", [bX.Create("style", "flex-grow: 1; padding: 20px; overflow-y: auto;")], [ba.BindView((fl) => { if(fl.$==1)return ba.Element("div", [], [ba.Element("h1", [], [ba.TextNode("Transactions")]), ba.Element("div", [bX.Create("style", "margin-bottom: 20px;")], [ba.Element("select", [bX.HandlerImpl("change", (fu) =>() => fh.Set(fu.value=="Income"?q:r))], [ba.Element("option", [bX.Create("value", "Income")], [ba.TextNode("Income")]), ba.Element("option", [bX.Create("value", "Expense")], [ba.TextNode("Expense")])]), ba.Element("select", [bX.HandlerImpl("change", (fu) =>() => fi.Set(fu.value))], [ba.Element("option", [bX.Create("value", "Entertainment")], [ba.TextNode("Entertainment")]), ba.Element("option", [bX.Create("value", "Food")], [ba.TextNode("Food")]), ba.Element("option", [bX.Create("value", "Salary")], [ba.TextNode("Salary")]), ba.Element("option", [bX.Create("value", "Transport")], [ba.TextNode("Transport")]), ba.Element("option", [bX.Create("value", "Bills")], [ba.TextNode("Bills")])]), ba.Element("input", [bX.Create("placeholder", "Amount (Ft)"), bX.Create("value", fj.Get()), bX.HandlerImpl("input", (fu) =>() => fj.Set(fu.value)), bX.Create("type", "number"), bX.Create("step", "1")], []), ba.Element("button", [bX.HandlerImpl("click", () =>() => { const fu=fj.Get()==null?"":fj.Get();const fv=parseInt(fu, globalThis.$radix);if(!isNaN(fv)&&!(fu==null)&&fu.length>0){ const fw=J(h(), fh.Get(), fi.Get(), fv);f().Append(fw);g(h()+1);return fj.Set("");} else return alert("Invalid amount! Please enter a valid integer (e.g., 1234).");})], [ba.TextNode("Add")])]), ba.Element("table", [bX.Create("style", "width: 100%; border-collapse: collapse;")], [ba.Element("thead", [], [ba.Element("tr", [], [ba.Element("th", [bX.Create("style", "border: 1px solid #ddd; padding: 8px;")], [ba.TextNode("Type")]), ba.Element("th", [bX.Create("style", "border: 1px solid #ddd; padding: 8px;")], [ba.TextNode("Category")]), ba.Element("th", [bX.Create("style", "border: 1px solid #ddd; padding: 8px;")], [ba.TextNode("Amount (Ft)")]), ba.Element("th", [bX.Create("style", "border: 1px solid #ddd; padding: 8px;")], [ba.TextNode("Actions")])])]), ba.Element("tbody", [], [ba.Convert((fu) => ba.Element("tr", [], [ba.Element("td", [bX.Create("style", "border: 1px solid #ddd; padding: 8px;")], [ba.TextNode(fu.Type.$==1?"Expense":"Income")]), ba.Element("td", [bX.Create("style", "border: 1px solid #ddd; padding: 8px;")], [ba.TextNode(fu.Category)]), ba.Element("td", [bX.Create("style", "border: 1px solid #ddd; padding: 8px;")], [ba.TextNode(String(fu.Amount))]), ba.Element("td", [bX.Create("style", "border: 1px solid #ddd; padding: 8px;")], [ba.Element("button", [bX.Create("style", "background-color: #f44336; color: white; border: none; padding: 5px 10px; cursor: pointer; border-radius: 3px;"), bX.HandlerImpl("click", () =>() => f().RemoveByKey(fu.Id))], [ba.TextNode("Delete")])])]), f().v)])]), ba.Element("div", [bX.Create("style", "margin-top: 20px;")], [ba.BindView((fu) => ba.Element("div", [], [ba.Element("p", [], [ba.TextNode("Total transactions: "+String(L(fu))+" (Income: "+String(L(K((fv) => fv.Type.$===0, fu)))+", Expense: "+String(L(K((fv) => fv.Type.$===1, fu)))+")")])]), f().v)]), ba.Element("div", [bX.Create("style", "margin-top: 20px; padding: 15px; background-color: #f5f8fa; border-radius: 5px;")], [ba.Element("h3", [], [ba.TextNode("Summary")]), ba.BindView((fu) => { const fv=M((fy) => fy.Amount, K((fy) => fy.Type.$===0, fu));const fw=M((fy) => fy.Amount, K((fy) => fy.Type.$===1, fu));const fx=fv-fw;return ba.Element("div", [], [ba.Element("p", [bX.Create("style", "font-weight: bold;")], [ba.TextNode("Total Income: "), ba.Element("span", [bX.Create("style", "color: green;")], [ba.TextNode(String(fv)+" Ft")])]), ba.Element("p", [bX.Create("style", "font-weight: bold;")], [ba.TextNode("Total Expense: "), ba.Element("span", [bX.Create("style", "color: red;")], [ba.TextNode(String(fw)+" Ft")])]), ba.Element("p", [bX.Create("style", "font-weight: bold;")], [ba.TextNode("Balance: "), ba.Element("span", [bX.Create("style", fx>=0?"color: green;":"color: red;")], [ba.TextNode(String(fx)+" Ft")])])]);}, f().v)])]);else if(fl.$==2){ let fm=ba.Element("h1", [], [ba.TextNode("Analytics")]);const fn=bh(P(O((fu) => fu.Category, f().u0076ar.Get())));const fo=M((fu) => fu.Amount, K((fu) => fu.Type.$===0, f().u0076ar.Get()));const fp=M((fu) => fu.Amount, K((fu) => fu.Type.$===1, f().u0076ar.Get()));const fq=bg((fu) => { const fv=M((fw) => fw.Amount, K((fw) => fw.Type.$===0&&fw.Category==fu, f().u0076ar.Get()));return fo>0?fv/fo*100:0;}, fn);const fr=bg((fu) => { const fv=M((fw) => fw.Amount, K((fw) => fw.Type.$===1&&fw.Category==fu, f().u0076ar.Get()));return fp>0?fv/fp*100:0;}, fn);let fs=ba.Element("div", [], [ba.Element("h3", [], [ba.TextNode("Income vs Expense by Category (Percentage Radar Chart)")]), ba.Element("div", [bX.Create("id", "chartContainer")], [ba.Element("canvas", [bX.Create("id", "radarChartCanvas"), bX.Create("width", "450"), bX.Create("height", "300"), bX.OnAfterRenderImpl((fu) => { if(d()==null){ } else { const fv=d().$0;if(fv&&typeof fv.destroy==="function")fv.destroy();} e(bb(new globalThis.Chart(fu.getContext("2d"), {type:"radar", data:{labels:fn, datasets:[{label:"Income (% of Total Income)", backgroundColor:"rgba(54, 162, 235, 0.2)", borderColor:"rgba(54, 162, 235, 1)", pointBackgroundColor:"rgba(54, 162, 235, 1)", data:fq}, {label:"Expense (% of Total Expense)", backgroundColor:"rgba(255, 99, 132, 0.2)", borderColor:"rgba(255, 99, 132, 1)", pointBackgroundColor:"rgba(255, 99, 132, 1)", data:fr}]}, options:{responsive:true, scales:{r:{beginAtZero:true, max:100, ticks:{stepSize:20, callback:(fw) => fw+"%"}}}, plugins:{tooltip:{callbacks:{label:(fw) => fw.dataset.label+": "+fw.parsed.r.toFixed(2)+"%"}}}}})));})], [])])]);let ft=[fm, fs, ba.BindView((fu) => { if(N(fu))return ba.Element("div", [bX.Create("style", "margin-top: 20px; color: #888;")], [ba.TextNode("No transactions yet. Add some transactions to see analytics.")]);else { const fv=u0035(P(O((fw) => fw.Category, fu)));return ba.Element("div", [bX.Create("style", "margin-top: 30px;")], [ba.Element("h3", [], [ba.TextNode("Category Breakdown")]), ba.Element("table", [bX.Create("style", "width: 100%; border-collapse: collapse;")], [ba.Element("thead", [], [ba.Element("tr", [], [ba.Element("th", [bX.Create("style", "border: 1px solid #ddd; padding: 8px; text-align: left;")], [ba.TextNode("Category")]), ba.Element("th", [bX.Create("style", "border: 1px solid #ddd; padding: 8px; text-align: right;")], [ba.TextNode("Income (Ft)")]), ba.Element("th", [bX.Create("style", "border: 1px solid #ddd; padding: 8px; text-align: right;")], [ba.TextNode("Expense (Ft)")]), ba.Element("th", [bX.Create("style", "border: 1px solid #ddd; padding: 8px; text-align: right;")], [ba.TextNode("Balance (Ft)")])])]), ba.Element("tbody", [], [ba.Concat(u0034((fw) => { const fx=M((fA) => fA.Amount, K((fA) => fA.Type.$===0&&fA.Category==fw, fu));const fy=M((fA) => fA.Amount, K((fA) => fA.Type.$===1&&fA.Category==fw, fu));const fz=fx-fy;return ba.Element("tr", [], [ba.Element("td", [bX.Create("style", "border: 1px solid #ddd; padding: 8px;")], [ba.TextNode(fw)]), ba.Element("td", [bX.Create("style", "border: 1px solid #ddd; padding: 8px; text-align: right;")], [ba.TextNode(String(fx))]), ba.Element("td", [bX.Create("style", "border: 1px solid #ddd; padding: 8px; text-align: right;")], [ba.TextNode(String(fy))]), ba.Element("td", [bX.Create("style", "border: 1px solid #ddd; padding: 8px; text-align: right; font-weight: bold; color: "+$(fz>=0?"green":"red"))], [ba.TextNode(String(fz))])]);}, fv))])])]);} }, f().v)];return ba.Element("div", [], ft);} else return ba.Element("div", [], [ba.Element("h1", [], [ba.TextNode("Welcome to Personal Budget Tracker")]), ba.Element("p", [], [ba.TextNode("The Personal Budget Tracker is a simple Single-Page Application built with F# and WebSharper to help you manage your finances.")]), ba.Element("p", [], [ba.TextNode("This application allows you to track your income and expenses, visualize your financial data, and gain insights into your spending habits.")]), ba.Element("p", [], [ba.TextNode("Track your income and expenses effortlessly, gain insights through analytics, and make informed financial decisions to achieve better savings.")])]);}, fg.View)])]);}
